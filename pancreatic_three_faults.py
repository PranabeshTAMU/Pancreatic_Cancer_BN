...
def pancreatic_three_faults (fault1, fault2, fault3, x1, x2, x3, x4, x5, x6, x7, x8):
  # Inputs
  ...
  if fault1 == 43 or fault2 == 43 or fault3 == 43:   
    CyclinD1 = 1 
  else:
    CyclinD1 = int(JNK or (not (GSK3 or gefitinib)) or (not(P16)) or (ERK and (not berberine)and (not gefitinib) and (not afatinib)))
  if fault1 == 44 or fault2 == 44 or fault3 == 44:   
    P21 = 0
  else:
    P21 = int((P53 or gemcitabine) and P16)
  if fault1 == 45 or fault2 == 45 or fault3 == 45:   
    CDK4by1 = 1 
  else:
    CDK4by1 = int((CyclinD1 and (not GANT61))or (not P16) or (not P21)) 
  if fault1 == 46 or fault2 == 46 or fault3 == 46:       
    Rb = 1 
  else:
    Rb = int(CDK4by1)
  if fault1 == 47 or fault2 == 47 or fault3 == 47:       
    RAD51 = 0
  else:
    RAD51 = int(BRCA2)
  if fault1 == 48 or fault2 == 48 or fault3 == 48:       
    P48 = 0
  else:    
    P48 = int(P53 or gemcitabine)
  if fault1 == 49 or fault2 == 49 or fault3 == 49:       
    BCL_XL = 1
  else:
